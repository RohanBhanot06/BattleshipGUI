...
public class MainMenu {
	...
	public MainMenu(JFrame theWindow){
		window = theWindow;
		backgroundImageIcon = new ImageIcon("mainMenu.png");
	...
	public void loadTitleScreen() {
		...
		errorMessage.setFont(new Font("Courier New", Font.BOLD, 15));
		errorMessage.setSize(460, 40);
		errorMessage.setLocation(window.getWidth()/2 - errorMessage.getWidth()/2,
				window.getHeight()-errorMessage.getHeight() - 30);
		errorMessage.setVisible(false);
		
		startGame = new JButton("Start Game");
		startGame.setFont(new Font("Courier New", Font.BOLD, 20));
		...
		gridSizeBtn.setFont(new Font("Courier New", Font.BOLD, 20));
		...
		battleshipSize.setFont(new Font("Courier New", Font.BOLD, 12));
		...
		battleshipCount.setFont(new Font("Courier New", Font.BOLD, 12));
		...
		cruiserSize.setFont(new Font("Courier New", Font.BOLD, 12));
		...
		cruiserCount.setFont(new Font("Courier New", Font.BOLD, 12));
		...
		destroyerSize.setFont(new Font("Courier New", Font.BOLD, 12));
		...
		destroyerCount.setFont(new Font("Courier New", Font.BOLD, 12));
		...
		submarineSize.setFont(new Font("Courier New", Font.BOLD, 12));
		...
		submarineCount.setFont(new Font("Courier New", Font.BOLD, 12));
